...
const letterWidth = 260;
const letterHeight = 260;
...
const lines = [
    {
        startX: 1050, startY: 560,
        controlPoints: [718, 500, 565, 600, 650, 800, 600, 1000],
        endX: 1050, endY: 900
      },
      {
        startX: 1195, startY: 550,
        controlPoints: [],
        endX: 1195, endY: 950
      },
];
...
function animateLine(onComplete) {
  ...
  requestAnimationFrame(() => animateLine(onComplete));
}

// #. document DOM객체가 모두 로드 되었을떄 실행
$(function() {
