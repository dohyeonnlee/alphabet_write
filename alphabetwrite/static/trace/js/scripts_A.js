document.addEventListener("DOMContentLoaded", function() {
    var infoSound =new Audio('/static/trace/info_sound/04_content_infoA.wav');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function submitCanvas() {
       ...
       mergedLink.click();
        ...
        // setTimeout(function() {
        //     window.location.href = '/trace/lowera/';
        // }, 3000);
    }
    ...
    async function uploadImage(blob, imageName, imageNumber) {
        ...
        try {
            const response = await fetch('/trace/upper-a/', {
                method: 'POST',
                body: formData
            });
            if (!response.ok) {
    ...
    function checkAnswers(predicted_label1) {
        ...
        const correctStrokeOrder = '341';// A의 답
        ...
        //획 인식 값이 있는 것
        // isCorrectPredictedLabel1
        //모양 값이 있는 것
        // isCorrectStrokeOrder
