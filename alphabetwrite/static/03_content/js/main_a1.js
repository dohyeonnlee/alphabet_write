...
document.addEventListener("DOMContentLoaded", function() {
    var infoSound =new Audio('/static/03_content/info_sound/03_content_infoa1.wav');
...
$(document).ready(function() {
    ...
    function startRoundSlider() {
        ...
        $("#round-slider1").roundSlider({
            ...
            update: function (args) {
                playSound();
                if (args.preValue - args.value >= 50) {
            ...
            stop: function(args) {
                ...
                if (args.value <= 0) {
                    ...
                    $(".rangeslider__fill").css("background-image", 'url("/static/03_content/images/guideline_4.png")');
                }
            }
        });
    ...
    function submitCanvas() {
        ...
        if (handle1Visible || handle2Visible) {
            ...
            setTimeout(function() {
                window.location.href = '/trace/lower-a';
            }, 3000);
        }
    }
});
