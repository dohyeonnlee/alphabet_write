...
document.addEventListener("DOMContentLoaded", function() {
    var infoSound =new Audio('/static/03_content/info_sound/03_content_infoB.wav');
...
$(document).ready(function() {
    ...
    function startRoundSlider() {
        ...
        $("#round-slider3").roundSlider({
            ...
            update: function (args) {
                playSound();
                if (args.value <= 0) {
                    $(".guideline-container2").show().css("width", "300px");
                } else if (args.value <= 30) {
                    $(".guideline-container2").show().css("width", "280px");
                } else if (args.value <= 40) {
                    $(".guideline-container2").show().css("width", "230px");
                } else if (args.value <= 60) {
                    $(".guideline-container2").show().css("width", "150px");
                } else if (args.value <= 80 ) {
        ...
        // Roundslider4 (RoundSlider3 뒤에 겹치는 부분)
    ...
    function submitCanvas() {
        ...
        if (handle1Visible || handle2Visible || handle3Visible) {
            ...
            setTimeout(function() {
                window.location.href = '/trace/upper-b';
            }, 3000);
        }
    }
});
